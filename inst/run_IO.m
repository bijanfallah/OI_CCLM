...
system('cp python_dir/INPUT.csv ./')
%system('cp /var/autofs/net/home/fallah/Documents/DATA_ASSIMILATION/Bijan/CODES/CCLM/Python_Codes/historical_runs_yearly_ensemble/src/TEMP/INPUT.csv ./')
system('cp python_dir/LON.out ./')
system('cp python_dir/LAT.out ./')
