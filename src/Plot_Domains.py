...
PDF    = 'Stations.pdf'
Plot_CCLM(dir_mistral='NETCDFS_CCLM/03/member_relax_3_big_00/post/',name=name_2,bcolor='black',var='T_2M',flag='FALSE',color_map='TRUE', alph=1, grids='FALSE', grids_color='red', rand_obs='TRUE', NN=NN)
col =['k','r','b','g','m']
t_o, lat_o, lon_o, rlat_o, rlon_o =rdfm(dir='NETCDFS_CCLM/03/member_relax_3_big_00/post/',
                                            name=name_2,
                                            var='T_2M')
